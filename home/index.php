    ...
    <div class="main">
        <div class="metric-cards">
            <div class="metric-card present">
                ...
                <p class="caption">out of 31 days</p>
            </div>
            <div class="metric-card late">
                <p class="title">Late</p>
                <div class="value">0</div>
                <p class="caption">out of 3 instances</p>
            </div>
            <div class="metric-card on-leave">
                <p class="title">Leave</p>
                <div class="value">0</div>
                <p class="caption">out of x</p>
            </div>
            <div class="metric-card absent">
                <p class="title">Absent</p>
                <div class="value">0</div>
                <p class="caption">out of 10 instance</p>
            </div>
        </div>
    ...
    <div class="leave-requests">
        <div class="list">
            <div class="item">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consectetur pariatur dolorem, vitae architecto laborum modi cupiditate fugit amet deserunt temporibus veniam et fuga aut. Obcaecati eligendi deserunt molestias at voluptate.</p>
            </div>
        </div>
    </div>
</body>
